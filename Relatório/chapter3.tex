...
\\A versão base escolhida será 2.2 pois mais de 98\% dos dispositivos possuem esta versão ou superior e esta versão oferece as funcionalidades necessárias. Ver Tabela~\ref{tab:android}.

\begin{table}[t]
  \centering
  \caption{Distribuição de dispositivos ativos por versão do sistema operativo Android (1 de maio de 2013)}
